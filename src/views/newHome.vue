...
const list = ref([
  {
    subject: '马原',
    src: 'Marx',
    icon: new URL('@/assets/icon/grape.svg', import.meta.url),
  },
  {
    subject: '近代史',
    src: 'CMH',
    icon: new URL('@/assets/icon/juice.svg', import.meta.url),
  },
  {
    subject: '思政',
    src: 'Political',
    icon: new URL('@/assets/icon/pear.svg', import.meta.url),
  },
  {
    subject: '毛概',
    src: 'MaoIntro',
    icon: new URL('@/assets/icon/lemon.svg', import.meta.url),
  },
  {
    subject: '习概',
    src: 'XiIntro',
    icon: new URL('@/assets/icon/cherry.svg', import.meta.url),
  },
  {
    subject: '社主史',
    src: 'SDH',
    icon: new URL('@/assets/icon/melon.svg', import.meta.url),
  },
  {
    subject: '新中国史',
    src: 'NCH',
    icon: new URL('@/assets/icon/bread.svg', import.meta.url),
  },
  {
    subject: '党史',
    src: 'CCPH',
    icon: new URL('@/assets/icon/tomato.svg', import.meta.url),
  },
  {
    subject: '改开史',
    src: 'ORH',
    icon: new URL('@/assets/icon/lettuce.svg', import.meta.url),
  }
])
