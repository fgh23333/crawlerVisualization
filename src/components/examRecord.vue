    ...
    <div class="question-container">
      <div v-for="(questions, type) in questionTypes" :key="type">
        ...
        <div class="question-grid">
          <span
            class="answer-status"
            :class="status[findQuestionIndex(question.id)]"
      ...
      <el-button type="primary" class="submit-btn" @click="submitAnswer"
        >提交</el-button
      >
    </div>
  </div>
...
export default {
  ...
  created() {
    const length =
      this.questionTypes.fillInTheBlank.length +
      this.questionTypes.multipleChoice.length +
      this.questionTypes.singleChoice.length +
      this.questionTypes.trueOrFalse.length
    this.length = length
